...
//        Log.e(TAG, "Google API client is not connected f/or autocomplete query.");
        return null;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.place_auto_complete_item,
                    parent, false);
        ...
        holder.description.setText(mResultList.get(position).description);
        return convertView;
    }
